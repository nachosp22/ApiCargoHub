...
public class VehiculoAdapter extends RecyclerView.Adapter<VehiculoAdapter.VehiculoViewHolder> {
    ...
    final class VehiculoViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(@NonNull Vehiculo vehiculo) {
            ...
            stateButton.setText(active ? R.string.vehicle_state_active : R.string.vehicle_state_inactive);
            int backgroundColor = ContextCompat.getColor(
                    itemView.getContext(),
                    active ? R.color.ch_success_soft : R.color.ch_error_soft
            );
            int textColor = ContextCompat.getColor(
                    itemView.getContext(),
                    active ? R.color.ch_success_text : R.color.ch_error_text
            );
            stateButton.setBackgroundTintList(ColorStateList.valueOf(backgroundColor));
            stateButton.setTextColor(textColor);

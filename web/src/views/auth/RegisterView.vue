<template>
  <div class="min-h-screen flex items-center justify-center bg-canvas dark:bg-gray-900 px-4 py-8">
    <div class="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 p-8">

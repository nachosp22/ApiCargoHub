...
public class IncidenciasActivasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_incidencias_activas, container, false);
    }
    ...
    private void loadIncidencias() {
        ...
        repository.getActivas(conductorId, new IncidenciaRepository.IncidenciasCallback() {
            @Override
